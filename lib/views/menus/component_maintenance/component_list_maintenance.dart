...
class ComponentMenuReady extends StatefulWidget {
  const ComponentMenuReady({
    super.key,
  });

  @override
  State<ComponentMenuReady> createState() => _ComponentMenuReadyState();
}

class _ComponentMenuReadyState extends State<ComponentMenuReady> {
  bool check = true;
  GroupButtonController? menu = GroupButtonController(selectedIndex: 0);
...
class ComponentMenuAfkir extends StatefulWidget {
  const ComponentMenuAfkir({
    super.key,
  });

  @override
  State<ComponentMenuAfkir> createState() => _ComponentMenuAfkirState();
}

class _ComponentMenuAfkirState extends State<ComponentMenuAfkir> {
  bool check = true;
  GroupButtonController? menu = GroupButtonController(selectedIndex: 0);
