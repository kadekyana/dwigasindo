                  ...
                  builder: (BuildContext context) {
                    return Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('Pilih Aksi Lanjutan', style: titleTextBlack),
            ...
            : Container(
                ...
                child: Column(
                  children: [
                    ...
                    const Divider(),
                    Expanded(
                      child: (provider.isiRak?.data?.length == 0)
                          ? Center(
                              child: Text(
                          ...
                          : GridView.builder(
                              ...
                              itemCount: provider
                                  .isiRak?.data?.length, // jumlah data dummy
                              itemBuilder: (context, index) {
                                final data = provider.isiRak?.data![index];
                                return ElevatedButton(
                                  onPressed: () {
                                    if (widget.title == 'C2H2') {
                                      _showCustomModalDetail(
                                          context,
                                          width,
                                          height,
                                          data.tubeNo!,
