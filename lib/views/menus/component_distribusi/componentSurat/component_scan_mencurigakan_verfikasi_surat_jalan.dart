...
class ComponentScanMencurigakanVerifikasiSuratJalan extends StatefulWidget {
  const ComponentScanMencurigakanVerifikasiSuratJalan({super.key});

  @override
  State<ComponentScanMencurigakanVerifikasiSuratJalan> createState() =>
      _ComponentScanMencurigakanVerifikasiSuratJalanState();
}

class _ComponentScanMencurigakanVerifikasiSuratJalanState
    extends State<ComponentScanMencurigakanVerifikasiSuratJalan> {
                          ...
                          onDetect: (BarcodeCapture barcode) {
                            if (barcode.barcodes.isNotEmpty) {
                              ...
                              if (code != null && code.isNotEmpty) {
                                ...
                                if (!context
                                    .read<ProviderScan>()
                                    .isCodeScanned(code, 'MENCURIGAKAN')) {
                                  // Jika belum, tambahkan ke list dan tampilkan pesan sukses
                                  context
                                      .read<ProviderScan>()
                                      .addScannedData(code, 'MENCURIGAKAN');
                                  _playBeep();
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                    content: Text(
                                        'Tidak ada barcode yang terdeteksi')),
                              );
                            }
                          },
                        ),
                    ...
                    child: Consumer<ProviderScan>(
                      builder: (context, providerScan, child) {
                        return ListView.builder(
                          itemCount:
                              providerScan.mencurigakanScannedData.length,
                          itemBuilder: (context, index) {
                            print(providerScan.mencurigakanScannedData[index]);
