...
class ComponentScanBlast extends StatefulWidget {
  ComponentScanBlast({super.key, required this.noBptk});
  String noBptk;

  @override
  State<ComponentScanBlast> createState() => _ComponentScanBlastState();
}

class _ComponentScanBlastState extends State<ComponentScanBlast> {
  final MobileScannerController cameraController = MobileScannerController();
  final AudioPlayer _audioPlayer = AudioPlayer();
  TextEditingController reason = TextEditingController();
  String? lastScannedCode; // Untuk menyimpan kode terakhir yang discan
  int scanCount = 0; // Menghitung berapa kali kode yang sama terdeteksi
  // final int maxScanCount = 1; // Set ke 10 kali pengecekan
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: WidgetAppbar(
        ...
        route: () {
          Future.delayed(const Duration(milliseconds: 500), () {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => ComponentScanQrCode(),
              ),
            );
          });
        },
        ...
        //       context.read<ProviderScan>().clearScannedData('QR');
        ...
        child: Padding(
          ...
          child: Column(
            children: [
                        ...
                        if (barcode.barcodes.isNotEmpty && !isCooldown) {
                          ...
                          if (code != null) {
                            ...
                            if (scanCount == 1) {
                              ...
                              if (provider.isCodeScanned(code, "QR") == false) {
                                _playBeep();
                                provider.addScannedData(code, "QR");
                                print("CEK : ${provider.qrScannedData}");
                                ...
                                print(
                                    "CEK TRUE : ${provider.isCodeScanned(code, "QR")}");
                                showTopSnackBar(
                                  Overlay.of(context),
              ...
              GestureDetector(
                onTap: () async {
                  for (var code in provider.qrScannedData) {
                    print(code);
                    provider.verifikasiBPTK(
                      context,
                      widget.noBptk,
                      0,
                      code,
